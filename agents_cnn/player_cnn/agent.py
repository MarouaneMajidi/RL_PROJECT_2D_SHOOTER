"""
CNN-based PPO Agent for Player Control
...
from .memory import CNNRolloutBuffer
from .config import CNNPlayerConfig


class CNNPlayerAgent:
    """
    CNN-based PPO Agent for player control.
    ...
    def __init__(self, config: CNNPlayerConfig):
        """
        Initialize CNN-based PPO agent.
        
        Args:
            config: CNNPlayerConfig object with hyperparameters
        """
        self.config = config
        ...
        self.rollout_buffer = CNNRolloutBuffer(
